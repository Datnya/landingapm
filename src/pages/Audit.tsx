        ...
        <div className="bg-white min-h-screen pt-20">
            ...
            <section className="relative h-[65vh] flex items-center overflow-hidden bg-black">
                <div className="absolute inset-0 z-0">
                    <iframe
                        src="https://www.youtube.com/embed/bnjHYgRGuWc?autoplay=1&mute=1&loop=1&playlist=bnjHYgRGuWc&controls=0&showinfo=0&rel=0&disablekb=1&modestbranding=1&playsinline=1"
